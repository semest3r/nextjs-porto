import { CsharpIcon, DotnetIcon, JavaScriptIcon, LaravelIcon, MariadbIcon, NextJSIcon, PhpIcon, PostgreIcon, PythonIcon, ReactIcon, VueIcon } from "@/SharedComponents/Icons"
...
export default function SkillSection() {
    return (
        <section id="skills" className="bg-white py-12">
            ...
            <div className="px-12 py-8 grid grid-cols-2 sm:grid-cols-7 place-content-center gap-8">
